...
if (fancyBody) {
  ...
  const projectsWrapper = document.createElement("span");
  projectsWrapper.innerText = projectsHeader.innerText;
  projectsHeader.innerText = "";
  projectsHeader.append(projectsWrapper);
  ...
  lightPart.append(projectsContainer);
